        ...
        if (
            ...
            $Pools | Where-Object Algorithm -eq $MinerAlgo | ForEach-Object {
                ...
                [PSCustomObject]@{
                    ...
                    Arguments         = "$Nicehash--disable-cpu --gpu-reset-oc --disable-worker-watchdog --disable-gpu-amd --adl-disable --algorithm $($MinerConfig.$ConfigType.naming.$($_.Algorithm)) --pool $($_.Pool_Host):$($_.Port) --wallet $($_.$User) --password $($_.$Pass)$Diff --api-enable --log-file `'$Log`' --api-port $Port $($MinerConfig.$ConfigType.commands.$($_.Algorithm))"
